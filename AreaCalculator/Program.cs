...
class Program
{
    ...
    {
        Console.WriteLine("Hello, and good day to you, for this exercise I want you to pick a shape: circle, triangle, rectangle, square");
        string shape = Console.ReadLine();
        
        if (shape == "circle")
        {
            // ask for radius and show circle area
            Console.WriteLine("Please enter the radius of the circle:");
            double radius = Convert.ToDouble(Console.ReadLine());
            Console.WriteLine($"The area of your circle is {CircleArea(radius)}");
        ...
        {
            // ask for base and height and calculate triangle area
            Console.WriteLine("What is the base length of your triangle?");
            double baseLength = Convert.ToDouble(Console.ReadLine());
            Console.WriteLine("What is the height of your triangle?");
            double height = Convert.ToDouble(Console.ReadLine());
            Console.WriteLine($"The area of your triangle is {TriangleArea(baseLength, height)}");
        ...
        else if (shape == "rectangle")
        {
            ...
            double length = Convert.ToDouble(Console.ReadLine());
            Console.WriteLine("Thank you, now tell me, what is the width or your rectangle?");
            double width = Convert.ToDouble(Console.ReadLine());
            Console.WriteLine($"The area of your rectangle is {RectangleArea(length, width)}");
        }
